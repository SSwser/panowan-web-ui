...
class RealESRGANer:
    ...
    Args:
        ...
        model_path (str): Local path to the pretrained model checkpoint.
    ...
    def __init__(
        ...
        if isinstance(model_path, list):
            ...
            if model_path.startswith("https://"):
                raise RuntimeError(
                    "Remote model URLs are not supported in the vendored RealESRGAN runtime. "
                    "Provide a local model_path instead."
                )
