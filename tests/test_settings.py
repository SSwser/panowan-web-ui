...
class SettingsTests(unittest.TestCase):
    ...
    def test_load_settings_includes_container_upscale_defaults(self) -> None:
        # SERVICE_ROLE forces _in_container() to return True, so we get container defaults.
    ...
    def test_load_settings_ignores_removed_legacy_panowan_app_dir(self) -> None:
        # SERVICE_ROLE=worker forces container mode so hardcoded paths apply.
